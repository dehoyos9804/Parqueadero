...
public class TableDynamicEmpresas {
    ...
    //constructor
    public TableDynamicEmpresas(TableLayout tableLayout, Context context) {
    ...
    /*private void newButton(){
        operaciones = new ImageButton(context);
        int id = context.getResources().getDrawable(R.drawable.ic_edi_custon);
        operaciones.setImageResource(id);
    }*/
